  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10 text-center">
        <div className="space-y-8 md:space-y-10 max-w-4xl mx-auto relative z-20">
        ...
        <div
          ref={decorativeRef}
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full pointer-events-none z-5 opacity-40 max-w-[1400px]"
        >
